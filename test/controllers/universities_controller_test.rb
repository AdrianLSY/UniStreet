...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { description: @university.description, name: @university.name, user_id: @university.user_id } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { description: @university.description, name: @university.name, user_id: @university.user_id } }
