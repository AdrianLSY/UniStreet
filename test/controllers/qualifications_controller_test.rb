...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { course_id: @qualification.course_id, user_id: @qualification.user_id } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { course_id: @qualification.course_id, user_id: @qualification.user_id } }
